...
Simple Usage:
    ...
    ... """
    >>> print markdown.markdown(text, ['abbr_once'])
...
Unlike the original extension, it will only replace each abbreviation once.
...
class AbbrExtension(Extension):
    ...
    def extendMarkdown(self, md, md_globals):
        ...
        md.preprocessors.add('abbr_once', AbbrPreprocessor(md), '<reference')
